...
def generate_sources_list(mirror_url, codename,
    ...
    """
    Generate the contents of ``/etc/apt/sources.list.d/official-package-repositories.list`` for an Linux Mint system.

    :param mirror_url: The base URL of the mirror (a string).
    :param codename: The codename of the Linux Mint release (a string like 'trusty' or 'xenial').
    ...
    for suite in suites:
        for directive in directives:
            lines.append(format(
                ...
                mirror=(SECURITY_URL if suite == 'security' else mirror_url),
